...
# source: prystine_detection/prystine/protos/losses.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='prystine_detection/prystine/protos/losses.proto',
  package='prystine_detection.prystine.protos',
  syntax='proto3',
  serialized_pb=_b('\n/prystine_detection/prystine/protos/losses.proto\x12\"prystine_detection.prystine.protos\"\xba\x02\n\x04Loss\x12O\n\x11localization_loss\x18\x01 \x01(\x0b\x32\x34.prystine_detection.prystine.protos.LocalizationLoss\x12S\n\x13\x63lassification_loss\x18\x02 \x01(\x0b\x32\x36.prystine_detection.prystine.protos.ClassificationLoss\x12P\n\x12hard_example_miner\x18\x03 \x01(\x0b\x32\x34.prystine_detection.prystine.protos.HardExampleMiner\x12\x1d\n\x15\x63lassification_weight\x18\x04 \x01(\x02\x12\x1b\n\x13localization_weight\x18\x05 \x01(\x02\"\x83\x02\n\x10LocalizationLoss\x12U\n\x0bweighted_l2\x18\x01 \x01(\x0b\x32>.prystine_detection.prystine.protos.WeightedL2LocalizationLossH\x00\x12\x62\n\x12weighted_smooth_l1\x18\x02 \x01(\x0b\x32\x44.prystine_detection.prystine.protos.WeightedSmoothL1LocalizationLossH\x00\x12\x1f\n\x17\x65ncode_rad_error_by_sin\x18\x03 \x01(\x08\x42\x13\n\x11localization_loss\"L\n\x1aWeightedL2LocalizationLoss\x12\x19\n\x11\x61nchorwise_output\x18\x01 \x01(\x08\x12\x13\n\x0b\x63ode_weight\x18\x02 \x03(\x02\"a\n WeightedSmoothL1LocalizationLoss\x12\x19\n\x11\x61nchorwise_output\x18\x01 \x01(\x08\x12\r\n\x05sigma\x18\x02 \x01(\x02\x12\x13\n\x0b\x63ode_weight\x18\x03 \x03(\x02\"\xa8\x04\n\x12\x43lassificationLoss\x12\x61\n\x10weighted_sigmoid\x18\x01 \x01(\x0b\x32\x45.prystine_detection.prystine.protos.WeightedSigmoidClassificationLossH\x00\x12\x61\n\x10weighted_softmax\x18\x02 \x01(\x0b\x32\x45.prystine_detection.prystine.protos.WeightedSoftmaxClassificationLossH\x00\x12i\n\x14\x62ootstrapped_sigmoid\x18\x03 \x01(\x0b\x32I.prystine_detection.prystine.protos.BootstrappedSigmoidClassificationLossH\x00\x12\x64\n\x16weighted_sigmoid_focal\x18\x04 \x01(\x0b\x32\x42.prystine_detection.prystine.protos.SigmoidFocalClassificationLossH\x00\x12\x64\n\x16weighted_softmax_focal\x18\x05 \x01(\x0b\x32\x42.prystine_detection.prystine.protos.SoftmaxFocalClassificationLossH\x00\x42\x15\n\x13\x63lassification_loss\">\n!WeightedSigmoidClassificationLoss\x12\x19\n\x11\x61nchorwise_output\x18\x01 \x01(\x08\"Y\n\x1eSigmoidFocalClassificationLoss\x12\x19\n\x11\x61nchorwise_output\x18\x01 \x01(\x08\x12\r\n\x05gamma\x18\x02 \x01(\x02\x12\r\n\x05\x61lpha\x18\x03 \x01(\x02\"Y\n\x1eSoftmaxFocalClassificationLoss\x12\x19\n\x11\x61nchorwise_output\x18\x01 \x01(\x08\x12\r\n\x05gamma\x18\x02 \x01(\x02\x12\r\n\x05\x61lpha\x18\x03 \x01(\x02\"S\n!WeightedSoftmaxClassificationLoss\x12\x19\n\x11\x61nchorwise_output\x18\x01 \x01(\x08\x12\x13\n\x0blogit_scale\x18\x02 \x01(\x02\"i\n%BootstrappedSigmoidClassificationLoss\x12\r\n\x05\x61lpha\x18\x01 \x01(\x02\x12\x16\n\x0ehard_bootstrap\x18\x02 \x01(\x08\x12\x19\n\x11\x61nchorwise_output\x18\x03 \x01(\x08\"\x97\x02\n\x10HardExampleMiner\x12\x19\n\x11num_hard_examples\x18\x01 \x01(\x05\x12\x15\n\riou_threshold\x18\x02 \x01(\x02\x12P\n\tloss_type\x18\x03 \x01(\x0e\x32=.prystine_detection.prystine.protos.HardExampleMiner.LossType\x12\"\n\x1amax_negatives_per_positive\x18\x04 \x01(\x05\x12\x1f\n\x17min_negatives_per_image\x18\x05 \x01(\x05\":\n\x08LossType\x12\x08\n\x04\x42OTH\x10\x00\x12\x12\n\x0e\x43LASSIFICATION\x10\x01\x12\x10\n\x0cLOCALIZATION\x10\x02\x62\x06proto3')
)
...
_HARDEXAMPLEMINER_LOSSTYPE = _descriptor.EnumDescriptor(
  name='LossType',
  full_name='prystine_detection.prystine.protos.HardExampleMiner.LossType',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_LOSS = _descriptor.Descriptor(
  name='Loss',
  full_name='prystine_detection.prystine.protos.Loss',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='localization_loss', full_name='prystine_detection.prystine.protos.Loss.localization_loss', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='classification_loss', full_name='prystine_detection.prystine.protos.Loss.classification_loss', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='hard_example_miner', full_name='prystine_detection.prystine.protos.Loss.hard_example_miner', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='classification_weight', full_name='prystine_detection.prystine.protos.Loss.classification_weight', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='localization_weight', full_name='prystine_detection.prystine.protos.Loss.localization_weight', index=4,
...
_LOCALIZATIONLOSS = _descriptor.Descriptor(
  ...
  full_name='prystine_detection.prystine.protos.LocalizationLoss',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='weighted_l2', full_name='prystine_detection.prystine.protos.LocalizationLoss.weighted_l2', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='weighted_smooth_l1', full_name='prystine_detection.prystine.protos.LocalizationLoss.weighted_smooth_l1', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='encode_rad_error_by_sin', full_name='prystine_detection.prystine.protos.LocalizationLoss.encode_rad_error_by_sin', index=2,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='localization_loss', full_name='prystine_detection.prystine.protos.LocalizationLoss.localization_loss',
...
_WEIGHTEDL2LOCALIZATIONLOSS = _descriptor.Descriptor(
  ...
  full_name='prystine_detection.prystine.protos.WeightedL2LocalizationLoss',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='anchorwise_output', full_name='prystine_detection.prystine.protos.WeightedL2LocalizationLoss.anchorwise_output', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='code_weight', full_name='prystine_detection.prystine.protos.WeightedL2LocalizationLoss.code_weight', index=1,
...
_WEIGHTEDSMOOTHL1LOCALIZATIONLOSS = _descriptor.Descriptor(
  ...
  full_name='prystine_detection.prystine.protos.WeightedSmoothL1LocalizationLoss',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='anchorwise_output', full_name='prystine_detection.prystine.protos.WeightedSmoothL1LocalizationLoss.anchorwise_output', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='sigma', full_name='prystine_detection.prystine.protos.WeightedSmoothL1LocalizationLoss.sigma', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='code_weight', full_name='prystine_detection.prystine.protos.WeightedSmoothL1LocalizationLoss.code_weight', index=2,
...
_CLASSIFICATIONLOSS = _descriptor.Descriptor(
  ...
  full_name='prystine_detection.prystine.protos.ClassificationLoss',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='weighted_sigmoid', full_name='prystine_detection.prystine.protos.ClassificationLoss.weighted_sigmoid', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='weighted_softmax', full_name='prystine_detection.prystine.protos.ClassificationLoss.weighted_softmax', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='bootstrapped_sigmoid', full_name='prystine_detection.prystine.protos.ClassificationLoss.bootstrapped_sigmoid', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='weighted_sigmoid_focal', full_name='prystine_detection.prystine.protos.ClassificationLoss.weighted_sigmoid_focal', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='weighted_softmax_focal', full_name='prystine_detection.prystine.protos.ClassificationLoss.weighted_softmax_focal', index=4,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='classification_loss', full_name='prystine_detection.prystine.protos.ClassificationLoss.classification_loss',
      index=0, containing_type=None, fields=[]),
  ],
...
_WEIGHTEDSIGMOIDCLASSIFICATIONLOSS = _descriptor.Descriptor(
  ...
  full_name='prystine_detection.prystine.protos.WeightedSigmoidClassificationLoss',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='anchorwise_output', full_name='prystine_detection.prystine.protos.WeightedSigmoidClassificationLoss.anchorwise_output', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SIGMOIDFOCALCLASSIFICATIONLOSS = _descriptor.Descriptor(
  ...
  full_name='prystine_detection.prystine.protos.SigmoidFocalClassificationLoss',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='anchorwise_output', full_name='prystine_detection.prystine.protos.SigmoidFocalClassificationLoss.anchorwise_output', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='gamma', full_name='prystine_detection.prystine.protos.SigmoidFocalClassificationLoss.gamma', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='alpha', full_name='prystine_detection.prystine.protos.SigmoidFocalClassificationLoss.alpha', index=2,
...
_SOFTMAXFOCALCLASSIFICATIONLOSS = _descriptor.Descriptor(
  ...
  full_name='prystine_detection.prystine.protos.SoftmaxFocalClassificationLoss',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='anchorwise_output', full_name='prystine_detection.prystine.protos.SoftmaxFocalClassificationLoss.anchorwise_output', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='gamma', full_name='prystine_detection.prystine.protos.SoftmaxFocalClassificationLoss.gamma', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='alpha', full_name='prystine_detection.prystine.protos.SoftmaxFocalClassificationLoss.alpha', index=2,
      number=3, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_WEIGHTEDSOFTMAXCLASSIFICATIONLOSS = _descriptor.Descriptor(
  ...
  full_name='prystine_detection.prystine.protos.WeightedSoftmaxClassificationLoss',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='anchorwise_output', full_name='prystine_detection.prystine.protos.WeightedSoftmaxClassificationLoss.anchorwise_output', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='logit_scale', full_name='prystine_detection.prystine.protos.WeightedSoftmaxClassificationLoss.logit_scale', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_BOOTSTRAPPEDSIGMOIDCLASSIFICATIONLOSS = _descriptor.Descriptor(
  ...
  full_name='prystine_detection.prystine.protos.BootstrappedSigmoidClassificationLoss',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='alpha', full_name='prystine_detection.prystine.protos.BootstrappedSigmoidClassificationLoss.alpha', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='hard_bootstrap', full_name='prystine_detection.prystine.protos.BootstrappedSigmoidClassificationLoss.hard_bootstrap', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='anchorwise_output', full_name='prystine_detection.prystine.protos.BootstrappedSigmoidClassificationLoss.anchorwise_output', index=2,
      number=3, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_HARDEXAMPLEMINER = _descriptor.Descriptor(
  ...
  full_name='prystine_detection.prystine.protos.HardExampleMiner',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='num_hard_examples', full_name='prystine_detection.prystine.protos.HardExampleMiner.num_hard_examples', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='iou_threshold', full_name='prystine_detection.prystine.protos.HardExampleMiner.iou_threshold', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='loss_type', full_name='prystine_detection.prystine.protos.HardExampleMiner.loss_type', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max_negatives_per_positive', full_name='prystine_detection.prystine.protos.HardExampleMiner.max_negatives_per_positive', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='min_negatives_per_image', full_name='prystine_detection.prystine.protos.HardExampleMiner.min_negatives_per_image', index=4,
...
Loss = _reflection.GeneratedProtocolMessageType('Loss', (_message.Message,), dict(
  DESCRIPTOR = _LOSS,
  __module__ = 'prystine_detection.prystine.protos.losses_pb2'
  # @@protoc_insertion_point(class_scope:prystine_detection.prystine.protos.Loss)
  ))
...
LocalizationLoss = _reflection.GeneratedProtocolMessageType('LocalizationLoss', (_message.Message,), dict(
  ...
  __module__ = 'prystine_detection.prystine.protos.losses_pb2'
  # @@protoc_insertion_point(class_scope:prystine_detection.prystine.protos.LocalizationLoss)
  ))
...
WeightedL2LocalizationLoss = _reflection.GeneratedProtocolMessageType('WeightedL2LocalizationLoss', (_message.Message,), dict(
  ...
  __module__ = 'prystine_detection.prystine.protos.losses_pb2'
  # @@protoc_insertion_point(class_scope:prystine_detection.prystine.protos.WeightedL2LocalizationLoss)
  ))
...
WeightedSmoothL1LocalizationLoss = _reflection.GeneratedProtocolMessageType('WeightedSmoothL1LocalizationLoss', (_message.Message,), dict(
  ...
  __module__ = 'prystine_detection.prystine.protos.losses_pb2'
  # @@protoc_insertion_point(class_scope:prystine_detection.prystine.protos.WeightedSmoothL1LocalizationLoss)
  ))
...
ClassificationLoss = _reflection.GeneratedProtocolMessageType('ClassificationLoss', (_message.Message,), dict(
  ...
  __module__ = 'prystine_detection.prystine.protos.losses_pb2'
  # @@protoc_insertion_point(class_scope:prystine_detection.prystine.protos.ClassificationLoss)
  ))
...
WeightedSigmoidClassificationLoss = _reflection.GeneratedProtocolMessageType('WeightedSigmoidClassificationLoss', (_message.Message,), dict(
  ...
  __module__ = 'prystine_detection.prystine.protos.losses_pb2'
  # @@protoc_insertion_point(class_scope:prystine_detection.prystine.protos.WeightedSigmoidClassificationLoss)
  ))
...
SigmoidFocalClassificationLoss = _reflection.GeneratedProtocolMessageType('SigmoidFocalClassificationLoss', (_message.Message,), dict(
  ...
  __module__ = 'prystine_detection.prystine.protos.losses_pb2'
  # @@protoc_insertion_point(class_scope:prystine_detection.prystine.protos.SigmoidFocalClassificationLoss)
  ))
...
SoftmaxFocalClassificationLoss = _reflection.GeneratedProtocolMessageType('SoftmaxFocalClassificationLoss', (_message.Message,), dict(
  ...
  __module__ = 'prystine_detection.prystine.protos.losses_pb2'
  # @@protoc_insertion_point(class_scope:prystine_detection.prystine.protos.SoftmaxFocalClassificationLoss)
  ))
...
WeightedSoftmaxClassificationLoss = _reflection.GeneratedProtocolMessageType('WeightedSoftmaxClassificationLoss', (_message.Message,), dict(
  ...
  __module__ = 'prystine_detection.prystine.protos.losses_pb2'
  # @@protoc_insertion_point(class_scope:prystine_detection.prystine.protos.WeightedSoftmaxClassificationLoss)
  ))
...
BootstrappedSigmoidClassificationLoss = _reflection.GeneratedProtocolMessageType('BootstrappedSigmoidClassificationLoss', (_message.Message,), dict(
  ...
  __module__ = 'prystine_detection.prystine.protos.losses_pb2'
  # @@protoc_insertion_point(class_scope:prystine_detection.prystine.protos.BootstrappedSigmoidClassificationLoss)
  ))
...
HardExampleMiner = _reflection.GeneratedProtocolMessageType('HardExampleMiner', (_message.Message,), dict(
  ...
  __module__ = 'prystine_detection.prystine.protos.losses_pb2'
  # @@protoc_insertion_point(class_scope:prystine_detection.prystine.protos.HardExampleMiner)
  ))
