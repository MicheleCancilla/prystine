# from prystine.core import box_np_ops
# from prystine.core import region_similarity
import numpy as np

from prystine_detection.prystine.core.target_ops import create_target_np
...
class TargetAssigner:
    ...
    def assign_v2(self,
        ...
        targets_dict["labels"] = np.concatenate([v.reshape(*feature_map_size, -1) for v in targets_dict["labels"]],
                                                axis=-1)
